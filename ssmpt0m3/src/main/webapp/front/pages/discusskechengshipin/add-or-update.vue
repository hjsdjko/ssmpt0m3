	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusskechengshipin`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
				...
				if(this.ruleForm.id){
					await this.$api.update(`discusskechengshipin`, this.ruleForm);
				}else{
					await this.$api.add(`discusskechengshipin`, this.ruleForm);
				}
				uni.setStorageSync('discusskechengshipinCleanType',true);
