	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusszuoyexinxi`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
				...
				if(this.ruleForm.id){
					await this.$api.update(`discusszuoyexinxi`, this.ruleForm);
				}else{
					await this.$api.add(`discusszuoyexinxi`, this.ruleForm);
				}
				uni.setStorageSync('discusszuoyexinxiCleanType',true);
