    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="完成内容" prop="wanchengneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.wanchengneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wanchengneirong" label="完成内容" prop="wanchengneirong">
                    <span v-html="ruleForm.wanchengneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.wanchengneirong = this.ruleForm.wanchengneirong.replace(reg,'../../../ssmpt0m3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
